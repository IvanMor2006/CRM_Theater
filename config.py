...
CONSTRAINTS = {
    ...
    'НеизменнаяДатаВПредставленииСБилетами': 'Нельзя изменять дату представления, на которое уже проданы билеты!',
    'ПродажаБилетаПозжеПредставления': 'Нельзя продать билет на уже пройденное представление!'
}
